...
class AppConfig:
    ...
    library_root_dir: str = str(DATA_DIR / "library" / "shelf")
    library_index_path: str = str(DATA_DIR / "library" / "library_index.json")
    ...
    export_sessions_dir: str = str(EXPORTS_DIR / "sessions")
...
os.makedirs(settings.library_root_dir, exist_ok=True)
os.makedirs(settings.documents_dir, exist_ok=True)
os.makedirs(settings.exports_dir, exist_ok=True)
os.makedirs(settings.export_sessions_dir, exist_ok=True)
